package com.example.blinkitcloneapp.viewmodels
...
class AuthViewModels:ViewModel() {
    ...
    val isSignedSuccessfully = _isSignedInSuccessfully
    ...
    fun sendOTP(useNumber: String ,activity:Activity){
        ...
        val options = PhoneAuthOptions.newBuilder(Utils.getAuthInstance())
            .setPhoneNumber("+91$useNumber") // Phone number to verify
